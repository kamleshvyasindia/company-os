...
> Installed: 2026-06-28. Keep this page current; every agent session starts here.
...
- **Operational Approvals**: Day-to-day work, proposals, and hiring require onerous internal approvals within Deloitte.
- GAP: No formalized workflow in the OS yet for tracking and logging decisions.

## Where work happens
- **Government Clients**: Work happens over email, WhatsApp, and basic Microsoft Office tools.
- **Private Sector Clients**: Work happens over email, WhatsApp, meeting recorders, and project management tools like Notion.
- **Internal Teams**: Collaborate via GitHub and email/WhatsApp. Meetings are currently NOT recorded.

## Tribal knowledge agents need
- **Skills Conflict**: The team is in constant conflict with Deloitte's Skill Development team over overlapping areas. The Education team must strictly avoid skills-related work and focus solely on education.
- **Technology Team Boundary**: Need to coordinate carefully with Deloitte's internal technology teams to avoid overstepping boundaries when delivering AI applications/training.
- **AI Delivery Strategy**: Developing external/contractual AI resources as service providers to bypass internal resource constraints.
- **Internal Support Dynamics**: The team must operate cohesively and support each other emotionally, as securing references and support internally is highly challenging due to large organization dynamics.
- **Audit Independence**: Strict audit independence checks are required before any new client/engagement is pursued.

## Gaps
- GAP: Recording of daily/weekly sync meetings.
- GAP: Standardized client satisfaction measurement.
- GAP: Precise active hiring counts/pipelines.
